      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          words: [
            ...
            { original: 'ucello', translation: 'bird' },
            { original: 'mucca', translation: 'cow' },
            { original: 'cavallo', translation: 'horse' },
            { original: 'colori', translation: 'colors' },
            { original: 'rosso', translation: 'red' },
            { original: 'giallo', translation: 'yellow' },
            { original: 'verde', translation: 'green' },
            { original: 'blu', translation: 'blue' },
            { original: 'viola', translation: 'purple' },
            { original: 'bianco', translation: 'white' },
            { original: 'nero', translation: 'black' },
            { original: 'pane', translation: 'bread' },
            { original: 'formaggio', translation: 'cheese' },
            { original: 'pollo', translation: 'chicken' },
            { original: 'pesce', translation: 'fish' },
            { original: 'frutta', translation: 'fruit' },
            { original: 'carne', translation: 'meat' },
            { original: 'insalata', translation: 'salad' },
            { original: 'mela', translation: 'apple' },
            { original: 'uva', translation: 'grapes' },
          ]
        }
        return supertest(app)
          .post('/api/user')
